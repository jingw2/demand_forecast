"""
Adjust croston model for intermittent time series
Paper: https://www.lancaster.ac.uk/pg/waller/pdfs/Intermittent_Demand_Forecasting.pdf
"""
        ...
        if list(nzd) != [0]:
                ...
                try:
                    ...
                    croston_training_result = _croston(
                                                            ...
                                                            epsilon = epsilon,
                                                            croston_variant = 'original', 
                                                            forecast_hyperbolic=forecast_hyperbolic
                                                      )
        ...
        if forecast_hyperbolic:
            ...
            for i in range(k, k+h):
                ...
                if len(max_seq) > 0:
                    ...
                    T = 0
                frc_out[i-k] = correction_factor * zfit[k-1] / (xfit[k-1] + a_interval * T / 2. + epsilon)
        else:
